...
public class infusedArmor extends ItemArmor {
	...
	public void registerIcons(IIconRegister reg){
		if(this == ItemRegistry.infused_boots)
			this.itemIcon = reg.registerIcon(Reference.MODID +":" + "infused_boots");
		if(this == ItemRegistry.infused_leggings)
			this.itemIcon = reg.registerIcon(Reference.MODID +":" + "infused_leggings");
		if(this == ItemRegistry.infused_chestplate)
			this.itemIcon = reg.registerIcon(Reference.MODID +":" + "infused_chestplate");
		if(this == ItemRegistry.infused_helmet)
			this.itemIcon = reg.registerIcon(Reference.MODID +":" + "infused_helmet");
	}
}