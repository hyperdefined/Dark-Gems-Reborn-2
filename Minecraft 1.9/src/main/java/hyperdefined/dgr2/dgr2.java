...
@Instance(Reference.MODID)
 	...
 	public static ArmorMaterial gemArmor = EnumHelper.addArmorMaterial("dark_armor", "dgr2:dark_armor", 33, new int[] {2, 6, 5, 2}, 9, SoundEvents.item_armor_equip_generic);
 	public static ArmorMaterial gem2Armor = EnumHelper.addArmorMaterial("infused_armor", "dgr2:infused_armor", 36, new int[] {4, 8, 7, 4}, 9, SoundEvents.item_armor_equip_generic);
 	public static ArmorMaterial gem3Armor = EnumHelper.addArmorMaterial("green_armor", "dgr2:green_armor", 39, new int[] {6, 10, 9, 6}, 13, SoundEvents.item_armor_equip_generic);
 	public static ArmorMaterial gem4Armor = EnumHelper.addArmorMaterial("blue_armor", "dgr2:blue_armor", 42, new int[] { 8, 12, 11, 8}, 15, SoundEvents.item_armor_equip_generic);
 	public static ArmorMaterial gem5Armor = EnumHelper.addArmorMaterial("magical_armor", "dgr2:magical_armor", 45, new int[] {10, 14, 13, 8}, 17, SoundEvents.item_armor_equip_generic);
