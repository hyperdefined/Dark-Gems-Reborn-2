...
@Instance(Reference.MODID)
 	...
 	public static ArmorMaterial gemArmor = EnumHelper.addArmorMaterial("dark_armor", "gem2Armor", 33, new int[] {2, 6, 5, 2}, 9);
 	public static ArmorMaterial gem2Armor = EnumHelper.addArmorMaterial("infused_armor", "gem2Armor", 36, new int[] {4, 8, 7, 4}, 9);
 	public static ArmorMaterial gem3Armor = EnumHelper.addArmorMaterial("green_armor", "gem3Armor", 39, new int[] {6, 10, 9, 6}, 13);
 	public static ArmorMaterial gem4Armor = EnumHelper.addArmorMaterial("blue_armor", "gem4Armor", 42, new int[] { 8, 12, 11, 8}, 15);
 	public static ArmorMaterial gem5Armor = EnumHelper.addArmorMaterial("magical_armor", "gem5Armor", 45, new int[] {10, 14, 13, 8}, 17);
 
 	public static IWorldGenerator dgr2OreGeneration = new OreGeneration();
